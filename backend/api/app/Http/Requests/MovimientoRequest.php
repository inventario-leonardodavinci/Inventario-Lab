...
class MovimientoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sub_ubicacion_origen_id'     => ['nullable', 'integer', 'exists:sub_ubicaciones,id'],
            'sub_ubicacion_destino_id'    => ['nullable', 'integer', 'exists:sub_ubicaciones,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'sub_ubicacion_origen_id.exists'  => 'La sub-ubicación de origen no existe.',
            'sub_ubicacion_destino_id.exists' => 'La sub-ubicación de destino no existe.',
